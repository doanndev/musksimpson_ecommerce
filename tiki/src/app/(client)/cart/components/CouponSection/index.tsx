  ...
  return (
    <div className='cart__checkout-coupon'>
      <div className='cart__checkout-coupon-header'>
        <h4 className='cart__checkout-coupon--title'>Musksimpson Khuyến Mãi</h4>
        <span className='cart__checkout-coupon--info' title='Áp dụng tối đa 1 Mã giảm giá Sản Phẩm và 1 Mã Vận Chuyển'>
          Có thể chọn 2
          <svg
