import { useLoginMutation, useLogoutMutation, useRegisterMutation, useSocialLoginMutation } from '@/api/auth/query';
...
export const useAuth = () => {
  ...
  const handleSetUserData = useCallback((user: UserResponseData, token: string) => {
